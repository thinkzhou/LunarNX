...
if "lunarnx-chiaki-packetstats-wrap.patch" in BUILD:
    raise AssertionError("the legacy packet-stats patch must not be applied to v15")
...
print("Chiaki packet-stats wrap archival test passed")
