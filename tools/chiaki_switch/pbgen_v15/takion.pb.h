...
typedef enum _tkproto_ExtMessage_PayloadType {
    tkproto_ExtMessage_PayloadType_RTT = 0,
    tkproto_ExtMessage_PayloadType_CLIENTMETRIC = 1,
    tkproto_ExtMessage_PayloadType_WIFIMETRICS = 2,
    tkproto_ExtMessage_PayloadType_CONGESTIONCONTROLCOORDINATOR = 3
} tkproto_ExtMessage_PayloadType;
...
typedef struct _tkproto_RttPayload {
    bool has_ping;
    bool ping;
    bool has_entry_index;
    uint32_t entry_index;
    bool has_orig_send_timestamp_us;
    int64_t orig_send_timestamp_us;
} tkproto_RttPayload;

typedef struct _tkproto_ExtMessage {
    tkproto_ExtMessage_PayloadType type;
    bool has_rtt_payload;
    tkproto_RttPayload rtt_payload;
} tkproto_ExtMessage;

typedef struct _tkproto_AddVirtualDeviceRpc {
    pb_callback_t sessionKey;
    int32_t playerId;
    int32_t deviceId;
    bool has_deviceType;
    int32_t deviceType;
} tkproto_AddVirtualDeviceRpc;

typedef struct _tkproto_AddVirtualDeviceResponse {
    bool result;
    pb_callback_t description;
} tkproto_AddVirtualDeviceResponse;

typedef struct _tkproto_RemoveVirtualDeviceRpc {
    pb_callback_t sessionKey;
    int32_t playerId;
    bool has_deviceType;
    int32_t deviceType;
} tkproto_RemoveVirtualDeviceRpc;

typedef struct _tkproto_AddVirtualMicRpc {
    pb_callback_t sessionKey;
    int32_t controllerId;
    int32_t deviceId;
} tkproto_AddVirtualMicRpc;

typedef struct _tkproto_RemoveVirtualMicRpc {
    pb_callback_t sessionKey;
    int32_t controllerId;
} tkproto_RemoveVirtualMicRpc;

typedef struct _tkproto_PlayTimeLeftEvent {
    pb_callback_t sessionKey;
    int32_t timeLeft;
    int32_t totalTime;
    pb_callback_t reason;
} tkproto_PlayTimeLeftEvent;

typedef struct _tkproto_SetProtectionEvent {
    pb_callback_t sessionKey;
    bool audioProtected;
    bool videoProtected;
} tkproto_SetProtectionEvent;
...
#define _tkproto_ExtMessage_PayloadType_MIN tkproto_ExtMessage_PayloadType_RTT
#define _tkproto_ExtMessage_PayloadType_MAX tkproto_ExtMessage_PayloadType_CONGESTIONCONTROLCOORDINATOR
#define _tkproto_ExtMessage_PayloadType_ARRAYSIZE ((tkproto_ExtMessage_PayloadType)(tkproto_ExtMessage_PayloadType_CONGESTIONCONTROLCOORDINATOR+1))
...
#define tkproto_ExtMessage_type_ENUMTYPE tkproto_ExtMessage_PayloadType
...
#define tkproto_RttPayload_init_default          {false, 0, false, 0, false, 0}
#define tkproto_ExtMessage_init_default          {_tkproto_ExtMessage_PayloadType_MIN, false, tkproto_RttPayload_init_default}
#define tkproto_AddVirtualDeviceRpc_init_default {{{NULL}, NULL}, 0, 0, false, 0}
#define tkproto_AddVirtualDeviceResponse_init_default {0, {{NULL}, NULL}}
#define tkproto_RemoveVirtualDeviceRpc_init_default {{{NULL}, NULL}, 0, false, 0}
#define tkproto_AddVirtualMicRpc_init_default    {{{NULL}, NULL}, 0, 0}
#define tkproto_RemoveVirtualMicRpc_init_default {{{NULL}, NULL}, 0}
#define tkproto_PlayTimeLeftEvent_init_default   {{{NULL}, NULL}, 0, 0, {{NULL}, NULL}}
#define tkproto_SetProtectionEvent_init_default  {{{NULL}, NULL}, 0, 0}
...
#define tkproto_RttPayload_init_zero             {false, 0, false, 0, false, 0}
#define tkproto_ExtMessage_init_zero             {_tkproto_ExtMessage_PayloadType_MIN, false, tkproto_RttPayload_init_zero}
#define tkproto_AddVirtualDeviceRpc_init_zero    {{{NULL}, NULL}, 0, 0, false, 0}
#define tkproto_AddVirtualDeviceResponse_init_zero {0, {{NULL}, NULL}}
#define tkproto_RemoveVirtualDeviceRpc_init_zero {{{NULL}, NULL}, 0, false, 0}
#define tkproto_AddVirtualMicRpc_init_zero       {{{NULL}, NULL}, 0, 0}
#define tkproto_RemoveVirtualMicRpc_init_zero    {{{NULL}, NULL}, 0}
#define tkproto_PlayTimeLeftEvent_init_zero      {{{NULL}, NULL}, 0, 0, {{NULL}, NULL}}
#define tkproto_SetProtectionEvent_init_zero     {{{NULL}, NULL}, 0, 0}
...
#define tkproto_RttPayload_ping_tag              1
#define tkproto_RttPayload_entry_index_tag       2
#define tkproto_RttPayload_orig_send_timestamp_us_tag 3
#define tkproto_ExtMessage_type_tag              1
#define tkproto_ExtMessage_rtt_payload_tag       2
#define tkproto_AddVirtualDeviceRpc_sessionKey_tag 1
#define tkproto_AddVirtualDeviceRpc_playerId_tag 2
#define tkproto_AddVirtualDeviceRpc_deviceId_tag 3
#define tkproto_AddVirtualDeviceRpc_deviceType_tag 4
#define tkproto_AddVirtualDeviceResponse_result_tag 1
#define tkproto_AddVirtualDeviceResponse_description_tag 2
#define tkproto_RemoveVirtualDeviceRpc_sessionKey_tag 1
#define tkproto_RemoveVirtualDeviceRpc_playerId_tag 2
#define tkproto_RemoveVirtualDeviceRpc_deviceType_tag 3
#define tkproto_AddVirtualMicRpc_sessionKey_tag  1
#define tkproto_AddVirtualMicRpc_controllerId_tag 2
#define tkproto_AddVirtualMicRpc_deviceId_tag    3
#define tkproto_RemoveVirtualMicRpc_sessionKey_tag 1
#define tkproto_RemoveVirtualMicRpc_controllerId_tag 2
#define tkproto_PlayTimeLeftEvent_sessionKey_tag 1
#define tkproto_PlayTimeLeftEvent_timeLeft_tag   2
#define tkproto_PlayTimeLeftEvent_totalTime_tag  3
#define tkproto_PlayTimeLeftEvent_reason_tag     4
#define tkproto_SetProtectionEvent_sessionKey_tag 1
#define tkproto_SetProtectionEvent_audioProtected_tag 2
#define tkproto_SetProtectionEvent_videoProtected_tag 3
...
#define tkproto_RttPayload_FIELDLIST(X, a) \
X(a, STATIC,   OPTIONAL, BOOL,     ping,              1) \
X(a, STATIC,   OPTIONAL, UINT32,   entry_index,       2) \
X(a, STATIC,   OPTIONAL, SINT64,   orig_send_timestamp_us,   3)
#define tkproto_RttPayload_CALLBACK NULL
#define tkproto_RttPayload_DEFAULT NULL

#define tkproto_ExtMessage_FIELDLIST(X, a) \
X(a, STATIC,   REQUIRED, UENUM,    type,              1) \
X(a, STATIC,   OPTIONAL, MESSAGE,  rtt_payload,       2)
#define tkproto_ExtMessage_CALLBACK NULL
#define tkproto_ExtMessage_DEFAULT NULL
#define tkproto_ExtMessage_rtt_payload_MSGTYPE tkproto_RttPayload

#define tkproto_AddVirtualDeviceRpc_FIELDLIST(X, a) \
X(a, CALLBACK, REQUIRED, STRING,   sessionKey,        1) \
X(a, STATIC,   REQUIRED, INT32,    playerId,          2) \
X(a, STATIC,   REQUIRED, INT32,    deviceId,          3) \
X(a, STATIC,   OPTIONAL, INT32,    deviceType,        4)
#define tkproto_AddVirtualDeviceRpc_CALLBACK pb_default_field_callback
#define tkproto_AddVirtualDeviceRpc_DEFAULT NULL

#define tkproto_AddVirtualDeviceResponse_FIELDLIST(X, a) \
X(a, STATIC,   REQUIRED, BOOL,     result,            1) \
X(a, CALLBACK, OPTIONAL, STRING,   description,       2)
#define tkproto_AddVirtualDeviceResponse_CALLBACK pb_default_field_callback
#define tkproto_AddVirtualDeviceResponse_DEFAULT NULL

#define tkproto_RemoveVirtualDeviceRpc_FIELDLIST(X, a) \
X(a, CALLBACK, REQUIRED, STRING,   sessionKey,        1) \
X(a, STATIC,   REQUIRED, INT32,    playerId,          2) \
X(a, STATIC,   OPTIONAL, INT32,    deviceType,        3)
#define tkproto_RemoveVirtualDeviceRpc_CALLBACK pb_default_field_callback
#define tkproto_RemoveVirtualDeviceRpc_DEFAULT NULL

#define tkproto_AddVirtualMicRpc_FIELDLIST(X, a) \
X(a, CALLBACK, REQUIRED, STRING,   sessionKey,        1) \
X(a, STATIC,   REQUIRED, INT32,    controllerId,      2) \
X(a, STATIC,   REQUIRED, INT32,    deviceId,          3)
#define tkproto_AddVirtualMicRpc_CALLBACK pb_default_field_callback
#define tkproto_AddVirtualMicRpc_DEFAULT NULL

#define tkproto_RemoveVirtualMicRpc_FIELDLIST(X, a) \
X(a, CALLBACK, REQUIRED, STRING,   sessionKey,        1) \
X(a, STATIC,   REQUIRED, INT32,    controllerId,      2)
#define tkproto_RemoveVirtualMicRpc_CALLBACK pb_default_field_callback
#define tkproto_RemoveVirtualMicRpc_DEFAULT NULL

#define tkproto_PlayTimeLeftEvent_FIELDLIST(X, a) \
X(a, CALLBACK, REQUIRED, STRING,   sessionKey,        1) \
X(a, STATIC,   REQUIRED, INT32,    timeLeft,          2) \
X(a, STATIC,   REQUIRED, INT32,    totalTime,         3) \
X(a, CALLBACK, OPTIONAL, STRING,   reason,            4)
#define tkproto_PlayTimeLeftEvent_CALLBACK pb_default_field_callback
#define tkproto_PlayTimeLeftEvent_DEFAULT NULL

#define tkproto_SetProtectionEvent_FIELDLIST(X, a) \
X(a, CALLBACK, REQUIRED, STRING,   sessionKey,        1) \
X(a, STATIC,   REQUIRED, BOOL,     audioProtected,    2) \
X(a, STATIC,   REQUIRED, BOOL,     videoProtected,    3)
#define tkproto_SetProtectionEvent_CALLBACK pb_default_field_callback
#define tkproto_SetProtectionEvent_DEFAULT NULL
...
extern const pb_msgdesc_t tkproto_RttPayload_msg;
extern const pb_msgdesc_t tkproto_ExtMessage_msg;
extern const pb_msgdesc_t tkproto_AddVirtualDeviceRpc_msg;
extern const pb_msgdesc_t tkproto_AddVirtualDeviceResponse_msg;
extern const pb_msgdesc_t tkproto_RemoveVirtualDeviceRpc_msg;
extern const pb_msgdesc_t tkproto_AddVirtualMicRpc_msg;
extern const pb_msgdesc_t tkproto_RemoveVirtualMicRpc_msg;
extern const pb_msgdesc_t tkproto_PlayTimeLeftEvent_msg;
extern const pb_msgdesc_t tkproto_SetProtectionEvent_msg;
...
#define tkproto_RttPayload_fields &tkproto_RttPayload_msg
#define tkproto_ExtMessage_fields &tkproto_ExtMessage_msg
#define tkproto_AddVirtualDeviceRpc_fields &tkproto_AddVirtualDeviceRpc_msg
#define tkproto_AddVirtualDeviceResponse_fields &tkproto_AddVirtualDeviceResponse_msg
#define tkproto_RemoveVirtualDeviceRpc_fields &tkproto_RemoveVirtualDeviceRpc_msg
#define tkproto_AddVirtualMicRpc_fields &tkproto_AddVirtualMicRpc_msg
#define tkproto_RemoveVirtualMicRpc_fields &tkproto_RemoveVirtualMicRpc_msg
#define tkproto_PlayTimeLeftEvent_fields &tkproto_PlayTimeLeftEvent_msg
#define tkproto_SetProtectionEvent_fields &tkproto_SetProtectionEvent_msg
...
/* tkproto_AddVirtualDeviceRpc_size depends on runtime parameters */
/* tkproto_AddVirtualDeviceResponse_size depends on runtime parameters */
/* tkproto_RemoveVirtualDeviceRpc_size depends on runtime parameters */
/* tkproto_AddVirtualMicRpc_size depends on runtime parameters */
/* tkproto_RemoveVirtualMicRpc_size depends on runtime parameters */
/* tkproto_PlayTimeLeftEvent_size depends on runtime parameters */
/* tkproto_SetProtectionEvent_size depends on runtime parameters */
...
#define tkproto_ExtMessage_size                  23
...
#define tkproto_RttPayload_size                  19
